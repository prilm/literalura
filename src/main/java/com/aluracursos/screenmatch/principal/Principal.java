...
public class Principal {
    ...
    private void filtrarSeriesPorTemporadaYEvaluacion(){
        System.out.println("¿Filtrar series por temporada y evaluacion? ");
        var totalTemporadas = teclado.nextLine();
        teclado.nextLine();
        System.out.println("¿Con evaluacion apartir de cuál valor?");
        var evaluacion = teclado.nextDouble();
        teclado.nextLine();
        List<Serie> filtroSeries = repositorio.seriesPorTemporadaYEvaluacion(Integer.parseInt(totalTemporadas), evaluacion);
